                              ...
                              trailing: SizedBox(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Checkbox(
                                      value: journalItem['isChecked'],
                                      onChanged: (value) {
                                        setState(() {
                                          journalItem['isChecked'] = value;
                                          if (value == true) {
                                            _archivedItems.add(journalItem);
                                            _journals.removeAt(index);
                                          } else {
                                            _archivedItems.remove(journalItem);
                                            _journals.insert(
                                                index, journalItem);
                                          }
                                        });
...
class ArchivedItemsPage extends StatelessWidget {
        ...
        itemBuilder: (context, index) {
          ...
          return ListTile(
            ...
            trailing: IconButton(
              ...
              onPressed: () {
                // Move the item back to the previous list
                _moveItemBack(index);
              },
            ),
            // Display other details of the archived item as desired
          );
        },
      ),
    );
  ...
  void _moveItemBack(int index) {
    // Retrieve the archived item
    final archivedItem = archivedItems[index];
